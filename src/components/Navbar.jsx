  ...
  return (
    <Container>
      ...
      <div className="my-10 mx-auto fixed top-0 left-0 hidden lg:flex justify-center h-20 items-center z-50 w-full">
        <div className="bg-dark-blue-gray flex items-center justify-between gap-6 py-4 px-20 rounded-full">
          <a href="#Homepage" >
            <div className='hover:opacity-75 flex items-center gap-6 '>
              <span >
              <svg  width="32px" height="24px" viewBox="0 0 32 32" enableBackground="new 0 0 32 32" id="Stock_cut" version="1.1" xmlSpace="preserve" xmlns="http://www.w3.org/2000/svg" xmlnsXlink="http://www.w3.org/1999/xlink" fill="#fcfcfc" stroke="#fcfcfc"><g id="SVGRepo_bgCarrier" strokeWidth="0"></g><g id="SVGRepo_tracerCarrier" strokeLinecap="round" strokeLinejoin="round"></g><g id="SVGRepo_iconCarrier"><desc></desc><polygon fill="none" points="31,16 31,19 27,19 27,31 21,31 21,19 11,19 11,31 5,31 5,19 1,19 1,16 16,1 21,6 21,1 27,1 27,12 " stroke="#ffffff" strokeLinejoin="round" strokeMiterlimit="10" strokeWidth="2"></polygon></g></svg>
              </span>
              <h2 className='font-medium 16 '>Home</h2>
            </div>
          </a>
